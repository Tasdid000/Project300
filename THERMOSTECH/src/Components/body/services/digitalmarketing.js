            ...
            <div className="container my-2">
                            ...
                            <ul className="col-lg-12" style={{ listStyle: "none" }}>
                                <li>
                                    <Col>
                                        ...
                                        Digital Marketing and Prototype
                                    </Col>
                                ...
                                <li>
                                    <Col>
                                        <img src="https://www.sjinnovation.com/themes/custom/sji_theme/images/tick.svg"
                                            style={{ marginRight: "5px" }} alt="pic" />
                                        Agile Digital Marketing at methodology
                                    </Col>
                                ...
                                <li>
                                    <Col>
                                        <img src="https://www.sjinnovation.com/themes/custom/sji_theme/images/tick.svg"
                                            style={{ marginRight: "5px" }} alt="pic" />
                                        Customized restaurant Digital Marketing for business
                                    </Col>
                            ...
                            <ul className="offset-lg-0 col-lg-12" style={{ listStyle: "none" }}>
                                ...
                                <li>
                                    <Col>
                                        <img src="https://www.sjinnovation.com/themes/custom/sji_theme/images/tick.svg"
                                            style={{ marginRight: "5px" }} alt="pic" />
                                        Digital Marketing based problems solution
                                    </Col>
                ...
                <Row>
                    <Col md="12" style={{ textAlign: "center" }}>
                        <img src="/assets/images/ads.png" alt="pic" height="150px" style={{ marginRight: "60px" }} />
                        <img src="/assets/images/googlea.png" alt="pic" height="150px" style={{ marginRight: "50px" }} />
                        <img src="/assets/images/hubsport.png" alt="pic" height="150px" style={{ marginRight: "50px" }} />
                        <img src="/assets/images/ahrefs.png" alt="pic" height="150px" style={{ marginRight: "50px" }} />
                        <img src="/assets/images/hoot.png" alt="pic" height="150px" style={{ marginRight: "50px" }} />
                        <img src="/assets/images/freelancer.png" height="150px" alt="pic" />
                    </Col>
                </Row>
                <div>
