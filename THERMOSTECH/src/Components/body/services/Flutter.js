    ...
    return (
        <div>
            ...
            <div className="container my-2">
                            ...
                            <ul className="col-lg-12" style={{ listStyle: "none" }}>
                                ...
                                <li>
                                    <Col>
                                        <img src="https://www.sjinnovation.com/themes/custom/sji_theme/images/tick.svg"
                                            style={{ marginRight: "5px" }} alt="pic" />
                                        Customize E-commerce app for buy sell and rent
                                    </Col>
                            ...
                            <ul className="offset-lg-0 col-lg-12" style={{ listStyle: "none" }}>
                                ...
                                <li>
                                    <Col>
                                        <img src="https://www.sjinnovation.com/themes/custom/sji_theme/images/tick.svg"
                                            style={{ marginRight: "5px" }} alt="pic" />
                                        Native, cross-platform based mobile app solution
                                    </Col>
                            ...
                            <ul className="offset-lg-0 col-lg-12" style={{ listStyle: "none" }}>
                                ...
                                <li>
                                    <Col>
                                        <img src="https://www.sjinnovation.com/themes/custom/sji_theme/images/tick.svg"
                                            style={{ marginRight: "5px" }} alt="pic" />
                                        Custom App for healthcare and education sector
                                    </Col>
                ...
                <Row>
                    <Col md="12">
                        <img src="/assets/images/android.png" alt="pic" style={{ marginRight: "50px" }} />
                        <img src="/assets/images/flutter.png" height="150px" alt="pic" style={{ marginRight: "50px" }} />
                        <img src="/assets/images/IOS.png" alt="pic" style={{ marginRight: "50px" }} />
                        <img src="/assets/images/dart.png" height="100px" alt="pic" style={{ marginRight: "50px" }} />
