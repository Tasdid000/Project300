                ...
                <div className="container my-2">
                                ...
                                <ul className="col-lg-12" style={{ listStyle: "none" }}>
                                    ...
                                    <li>
                                        <Col>
                                            <img src="https://www.sjinnovation.com/themes/custom/sji_theme/images/tick.svg"
                                                style={{ marginRight: "5px" }} alt="pic" />
                                            Customize E-commerce UI & UX for buy sell and rent
                                        </Col>
                                    ...
                                    <li>
                                        <Col>
                                            <img src="https://www.sjinnovation.com/themes/custom/sji_theme/images/tick.svg"
                                                style={{ marginRight: "5px" }} alt="pic" />
                                            Agile UI & UX design and development methodology
                                        </Col>
                                ...
                                <ul className="offset-lg-0 col-lg-12" style={{ listStyle: "none" }}>
                                    <li>
                                        <Col>
                                            <img src="https://www.sjinnovation.com/themes/custom/sji_theme/images/tick.svg"
                                                style={{ marginRight: "5px" }} alt="pic" />
                                            UI & UX for the tourism industry
                                        </Col>
                                    ...
                                    <li>
                                        <Col>
                                            <img src="https://www.sjinnovation.com/themes/custom/sji_theme/images/tick.svg"
                                                style={{ marginRight: "5px" }} alt="pic" />
                                            Customized restaurant UI & UX for business
                                        </Col>
                    ...
                    <Row>
                        <Col md="12" style={{ textAlign: "center" }}>
                            <img src="/assets/images/html.png" alt="pic" height="150px" style={{ marginRight: "60px" }} />
                            <img src="/assets/images/css.png" alt="pic" height="150px" style={{ marginRight: "50px" }} />
                            <img src="/assets/images/js.png" alt="pic" height="150px" style={{ marginRight: "50px" }} />
